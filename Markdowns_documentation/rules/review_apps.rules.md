...
| 3 | `Amperage Rating` (+`UoM`) / `Ampere` | nameplate/AI extraction | ✅ (`100 A BRK`) | Parse from label; bare value (`100`), UoM `AMP`. `BRK` noted as breaker-rating context in Description. |
